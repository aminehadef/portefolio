 ...
 */
final class Version20190515170351 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE project ADD tags_text VARCHAR(255) NOT NULL, ADD updated DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE project DROP tags_text, DROP updated');
    }
}
